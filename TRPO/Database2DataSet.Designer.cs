...
namespace TRPO {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class LibraryDataTable : global::System.Data.TypedTableBase<LibraryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public LibraryRow AddLibraryRow(int Id, string ФИО, string Информация) {
        ...
        public partial class LibraryRow : global::System.Data.DataRow {
            ...
            public string Информация {
                get {
                    try {
                        return ((string)(this[this.tableLibrary.ИнформацияColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Информация\' в таблице \'Library\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableLibrary.ИнформацияColumn] = value;
                }
            }
            ...
            public bool IsИнформацияNull() {
                return this.IsNull(this.tableLibrary.ИнформацияColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetИнформацияNull() {
                this[this.tableLibrary.ИнформацияColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace TRPO.Database2DataSetTableAdapters {
    ...
    public partial class LibraryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Library] WHERE (([Id] = @Original_Id) AND ((@IsNull_ФИО = 1 AN" +
                "D [ФИО] IS NULL) OR ([ФИО] = @Original_ФИО)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Library] ([Id], [ФИО], [Информация]) VALUES (@Id, @ФИО, @Инфор" +
                "мация);\r\nSELECT Id, ФИО, Информация FROM Library WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Library] SET [Id] = @Id, [ФИО] = @ФИО, [Информация] = @Информация W" +
                "HERE (([Id] = @Original_Id) AND ((@IsNull_ФИО = 1 AND [ФИО] IS NULL) OR ([ФИО] =" +
                " @Original_ФИО)));\r\nSELECT Id, ФИО, Информация FROM Library WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TRPO.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ФИО, Информация FROM dbo.Library";
        ...
        public virtual int Insert(int Id, string ФИО, string Информация) {
        ...
        public virtual int Update(int Id, string ФИО, string Информация, int Original_Id, string Original_ФИО) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string Информация, int Original_Id, string Original_ФИО) {
            return this.Update(Original_Id, ФИО, Информация, Original_Id, Original_ФИО);
        }
    }
